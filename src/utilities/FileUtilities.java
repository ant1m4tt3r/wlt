...
public class FileUtilities {
	...
	/**
	 * Returns the length of the file in the <code>pathname</code> using a
	 * {@link DecimalFormat} with the <b>0.00</b> pattern.
	 * 
	 * @param pathname
	 */
	...
	/**
	 * Returns the file length using a {@link DecimalFormat} with the
	 * <b>0.00</b> pattern.
	 * 
	 * @param file
	 */
	...
	/**
	 * Returns the size using a {@link DecimalFormat} with the <b>0.00</b>
	 * pattern.
	 * 
	 * @param size
	 */
	...
	/**
	 * Returns the length of the file contained in the <code>pathname</code>
	 * using a {@link DecimalFormat} with the <b>0.00 KB/MB/GB</b> pattern.
	 * 
	 * @param pathname
	 * @return
	 */
	...
	/**
	 * Returns the length of the file using a {@link DecimalFormat} with the
	 * <b>0.00 KB/MB/GB</b> pattern.
	 * 
	 * @param file
	 * @return
	 */
	...
	/**
	 * Returns the size using a {@link DecimalFormat} with the <b>0.00
	 * KB/MB/GB</b> pattern.
	 * 
	 * @param size
	 * @return
	...
	/**
	 * Takes a screenshot and saves it on the <code>path</code>. The default
	 * extension is PNG.
	 * 
	 * @param path
	 *            Output file.
	...
	/**
	 * Takes a screenshot and saves it on the <code>path</code> with the
	 * determined <code>extension</code>.
	 * 
	 * @param path
	 *            output file.
	 * @param extension
	...
	/**
	 * M茅todos copiados da classe FileServices.
	 */
	...
	public static final void renameDirectory(File oldFile, File newFile) throws Exception {
		...
		if (!oldFile.renameTo(newFile)) {
			throw new Exception("Falha ao renomear o diret贸rio!");
		}
	}
	...
	/**
	 * Returns an {@link LinkedList} containing the files on the
	 * <code>diretoryFile</code>.
	 * 
	 * @param path
	...
	public static final String extractExtension(String filename) throws Exception {
		...
		if (index == -1) {
			throw new Exception(String.format("Extens鉶 n鉶 encontrada para o arquivo %s", filename));
		}
